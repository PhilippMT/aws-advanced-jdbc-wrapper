...
dependencies {
    ...
    compileOnly("software.amazon.awssdk:http-client-spi:2.31.54") // Required for IAM (light implementation)
    ...
    testImplementation("software.amazon.awssdk:http-client-spi:2.31.54") // Required for IAM (light implementation)
